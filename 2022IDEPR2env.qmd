...
```{r}
# Yield
covcor_heat(matrix = met_results$VCOV$yield_ha$CORR, legend =c(0.35, 0.8))
...
covcor_heat(matrix = met_results$VCOV$DM_gravity$CORR, legend =c(0.35, 0.8))
...
covcor_heat(matrix = met_results$VCOV$plant_type$CORR, legend =c(0.35, 0.8))
